...
// ============================================================
function StudentsTab({ students, subjects, attendance, addStudent, editStudent, removeStudent }) {
...
function MarkTab({ subjects, studentsFor, attendance, setMark, getSession, setSession }) {
  ...
  const presentCount = roster.filter((st) => (attendance[`${st.id}__${subjectId}__${date}`] || "present") === "present").length;
